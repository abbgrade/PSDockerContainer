...
[string] $manifestFilePath = "$sourcePath\PSDockerContainer.psd1"
[string] $moduleBuildPath = "$buildPath\PSDockerContainer"
...
task UpdateDocs {
	...
	# New-MarkdownHelp -Module PSDockerContainer -OutputFolder .\docs
